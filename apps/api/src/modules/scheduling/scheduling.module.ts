...
@Module({
  ...
  controllers: [SchedulingController, AppointmentsController, SchedulingConfigController],
  providers: [SchedulingService, HoldsService, AppointmentsService, RemindersService, SchedulingConfigService, SchedulingProcessor, SchedulingScheduler],
